        ...
        ***/
        ...
        switch (_book.mode) {
            case 'portrait':
                ...
                let p = (parseInt(currentPage) - 2) < 1 ? _book.pages.length : (parseInt(currentPage) - 2) % parseInt(_book.pages.length)

                _book.sidePagesLeft = [_book.pages[`${ currentIndex - 2 }`], _book.pages[`${ currentIndex - 1 }`]]
                _book.sidePagesRight = [_book.pages[`${ currentIndex + 1 }`], _book.pages[`${ currentIndex + 2 }`]]
            ...
            case 'landscape':
                if (isEven(parseInt(currentPage))) {
                    ...
                    ***/
                    ...
                    _book.sidePagesLeft = [_book.pages[`${ currentIndex - 2 }`], _book.pages[`${ currentIndex - 1 }`]]
                    _book.sidePagesRight = [_book.pages[`${ currentIndex + 2 }`], _book.pages[`${ currentIndex + 3 }`]]

                } else {

                    _book.sidePagesLeft = [_book.pages[`${ currentIndex - 3 }`], _book.pages[`${ currentIndex - 2 }`]]
                    _book.sidePagesRight = [_book.pages[`${ currentIndex + 1 }`], _book.pages[`${ currentIndex + 2 }`]]
        ...
        console.log(_book.sidePagesLeft)
        console.log(_book.sidePagesRight)
