...
(((w, d, undefined) => {
    ...
    class Book {
        ...
        area() {
            console.log('Implement graph and quadrants')
        }
        ...
        removePage(pageNo) {
            ...
            if (index.between(0, _book.pages.length)) _removePage(pageNo)
    ...
    function _removePage(pageNo) {
        // TODO: Remove eventListeners please. Avoid memory leakages.
