...
(((w, d, undefined) => {
  ...
  function _wrapHtml (pageObj, currentIndex) {
    ...
    if (isEven(currentIndex)) {
      cssString = 'float: left; pointer-events: none; position:absolute; top: 0; left :0; overflow:none; height: 100%; '
    } else {
      cssString = 'float: right; pointer-events: none; position:absolute; top: 0; left :0; overflow:none; height: 100%;'
    }

    newWrapper.setAttribute('style', cssString)
      ...
      case 'landscape':
        switch (type) {
          case 'view':
            ...
            if (isEven(currentIndex)) {
              cssString = 'float: left; position: absolute; top: 0; left: 0; z-index: 3; pointer-events:none;'
            } else {
              cssString = 'float: right; position: absolute; top: 0; right: 0; z-index: 3; pointer-events:none;'
            }
          ...
          case 'rightPages':
            ...
            if (isEven(currentIndex)) {
              cssString = 'float: right; position: absolute; top: 0; right: 0; z-index: 2; pointer-events:none;'
            } else {
              cssString = 'float: right; position: absolute; top: 0; right: 0; z-index: 1; pointer-events:none;'
            }
          ...
          case 'leftPages':
            ...
            if (isEven(currentIndex)) {
              cssString = 'float: left; position: absolute; top: 0; left: 0; z-index: 1; pointer-events:none;'
            } else {
              cssString = 'float: left; position: absolute; top: 0; left: 0; z-index: 2; pointer-events:none;'
            }
