...
((w, d, undefined) => {
    function flippy() {
        ...
        _book.flipping = false

        _book.flipped = true // Custom event?

        _book.zooming = false // boolean state

        _book.zoomed = true // boolean state

        _book.page = () => 'current_page'

        _book.area = () => '[height, width]'
