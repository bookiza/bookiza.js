...
(((w, d, undefined) => {
    ...
    function _setView(currentPage = 1) {
        ...
        console.log('VIEW', _book.viewablePages)
        return
        ...
        ***/
        ...
        switch (_book.mode) {
            case 'portrait':
                ...
                console.log('pee', 'que', 'aar', 'ess', p, q, r, s)
        ...
        console.log('LeftPages', _book.sidePagesLeft)
        console.log('RightPages', _book.sidePagesRight)
